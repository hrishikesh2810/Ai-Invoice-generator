...
import { Loader2, Trash2, Edit, Search, FileText, Plus, AlertCircle, Sparkles, Mail, Filter, TrendingUp, IndianRupee } from 'lucide-react';
                  ...
                  {filteredInvoices.map(invoice => (
                    ...
                    >
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <span
                          className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold border-2 ${invoice.status === 'Paid'
