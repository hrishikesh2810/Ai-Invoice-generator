...
<div className='px-6 py-4 border-b border-slate-200 bg-slate-50'>
  <h3 className='text-lg font-smibold text-slate-900'>My Profile</h3>
</div>
...
<form onSubmit={handleUpdateProfile}>
  <div className='p-6 space-y-6'>
    ...
    <div className='pt-6 border-t border-slate-200'>
      ...
      <p className='text-sm text-slate-500 mt-1 mb-4'>This will be used to pre-fill the "Bill Form" section of your invoices.</p>
      <div className='space-y-4'>
        ...
        <InputField label="Phone" name="phone" icon={Phone} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="123-456-789"/>
      </div>
    </div>
  </div>
  ...
  <div className='px-6 py-4 bg-slate-50  border-t border-slate-200 flex justify-end'>
    <button type="submit" disabled={isUpdating} className='inline-flex items-center px-4  justify-center py-2 h-10 bg-blue-900 hover:bg-blue-800 text-white font-medium text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed'>
