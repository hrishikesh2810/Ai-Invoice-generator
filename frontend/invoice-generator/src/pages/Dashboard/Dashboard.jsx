...
import { Loader2, FileText, Plus, TrendingUp, ArrowUpRight, Clock } from "lucide-react";
                ...
                <tbody className="divide-y divide-slate-100">
                  {recentInvoices.map((invoice) => (
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${invoice.status === "Paid"
